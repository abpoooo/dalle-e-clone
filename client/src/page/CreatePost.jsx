...
const CreatePost = () => {
  ...
  const generateImg = async () => {
    if (form.prompt) {
      try {
        ...
        const response = await fetch('https://dalle-e-12bm.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo){
      ...
      try {
        const response = await fetch('https://dalle-e-12bm.onrender.com/api/v1/post', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          >
            ...
            {generatingImg && (
              <div
               ...
               items-center rounded-lg bg-[rgba(0,0,0,0.5)]"
              >
                <Loader />
              </div>
            )}
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className=" text-white bg-green-700 
              font-medium rounded-md text-sm w-full px-5 py-2.5 sm:w-auto text-center"
          >
